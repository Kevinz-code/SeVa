MODEL_VERSION=llava_loraft_dpo_our_ocrlv8kfilter4k_diffu800_textvqa8kfilter6k_diffu800_r1024_a2048
...
#     --version v1 \
#     --ocr_data_path /data/hypertext/zhuk/HA-DPO/ha_dpo/data/ours/ocr_llava665k/merged_answer_file_8k_filter4k_diffusion_step800.json \
#     --ocr_image_path /data/hypertext/zhuk/llava/LLaVA/data/ocr_vqa/images/ \
#     --textvqa_data_path /data/hypertext/zhuk/HA-DPO/ha_dpo/data/ours/textvqa_llava/merged_answer_file_8k_filter6k_diffusion_step800.json \
