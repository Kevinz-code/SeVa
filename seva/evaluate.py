...
if __name__ == "__main__":
    ...
    ans_file_list = ['/data/hypertext/zhuk/HA-DPO/ha_dpo/models/llava-v1_5/pope_result/{}/pope_random.jsonl'.format(args.path),
                     '/data/hypertext/zhuk/HA-DPO/ha_dpo/models/llava-v1_5/pope_result/{}/pope_popular.jsonl'.format(args.path),
                     '/data/hypertext/zhuk/HA-DPO/ha_dpo/models/llava-v1_5/pope_result/{}/pope_adv.jsonl'.format(args.path)]
